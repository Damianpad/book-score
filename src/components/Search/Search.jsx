...
const Search = () => {
  ...
  const searchBook = () => {
    ...
    const apiUrl = `https://openlibrary.org/search.json?q=${bookName}&start=${counter}&rows=${base}`;
    console.log(counter);
    fetch(apiUrl)
  ...
  if (loading) {
    ...
    return (
      <div role="status" className="flex items-center justify-center h-screen">
        <svg
          aria-hidden="true"
          className="w-20 h-20 text-gray-200 animate-spin dark:text-gray-600 fill-blue-400 mx-auto my-auto"
          viewBox="0 0 100 101"
          fill="none"
